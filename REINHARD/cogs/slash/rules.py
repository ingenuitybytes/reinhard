...
class Rules(commands.Cog):
    ...
    async def rules(self, interaction: discord.Interaction) -> None:
        ...
        embed.add_field(name=f'**ALLGEMEIN** {BlurpleEmoji.BLURPLEANNOUNCEMENTS_EMOJI}', value='• [**Nutzungsbedingungen**](https://discord.com/terms) und [**Community-Richtlinien**](https://discord.com/guidelines) einhalten\n • verwende keinen beleidigenden Benutzernamen oder Status\n • keine Themen über Politik und Religion\n • jegliche Art von __Werbung__ oder __NSFW Inhalte__ = **Ban**', inline=False)
        embed.add_field(name=f'**TEXTKANÄLE** {BlurpleEmoji.BLURPLETEXTCHANNEL_EMOJI}', value='• pro Nachricht max. 8 Emojis / 4 @Erwähnungen / 3 Spoiler\n • jegliche Art von Spam oder CAPS ist nicht erwünscht\n • sende nur Links, die erlaubt sind | Liste erlaubter Links\n • schreibe im vorgesehenen Kanal\n • erwähne keinen mit der <@&820402128383901758> oder <@&488680209730764811> Rolle', inline=False)
        embed.add_field(name=f'**SPRACHKANÄLE** {BlurpleEmoji.BLURPLEVOICECHANNEL_EMOJI}', value='• keine Aufnahmen ohne Erlaubnis aller Beteiligten\n • unterlasse störende/rauschende Geräusche\n • wechsle nicht ständig die Channel', inline=False)
        embed.add_field(name=f'**DAS TEAM** {BlurpleEmoji.BLURPLEEMPLOYEE_EMOJI}', value='• verteilt Verwarnungen & Strafen nach eigenem ermessen\n • kann Regeln vorübergehend aufheben/verschärfen\n • hat dir gegenüber ein Weisungsrecht', inline=False)
        embed.add_field(name=f'**SCHLUSSWORT** {BlurpleEmoji.BLURPLETICKET_EMOJI}', value='Das Regelwerk kann jederzeit geändert werden, halte dich bitte selbständig auf dem Laufenden. Gegen nicht aufgeführte Aktionen werden wir, wenn es nötig ist, ebenfalls moderativ durchgreifen.', inline=False)
